          ...
          <div className="relative">
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
                <a href="/profile_patient" className="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100">
      ...
      >
        ...
        <div className="px-4 py-2 border-t border-white border-opacity-20">
          ...
          <div className="space-y-1">
            <a href="/profile_patient" className="block text-white hover:text-sky-300 text-sm py-1">Mi Perfil</a>
